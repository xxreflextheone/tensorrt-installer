...
#cuda toolkit 12.8: https://developer.download.nvidia.com/compute/cuda/12.8.1/local_installers/cuda_12.8.1_572.61_windows.exe
...
if restart:
    os.system('py 50_series.py --bat-launch')
    print('restarting...')
    quit()
...
def installCudaToolkit():
    ...
    f = open("output.txt", "w")
    download_link = 'https://developer.download.nvidia.com/compute/cuda/12.8.1/local_installers/cuda_12.8.1_572.61_windows.exe'
    file_path = "cuda_12.8.1_572.61_windows.exe"
